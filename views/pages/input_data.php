  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="">
        ...
        <hr>
        <form class = "form-horizontal" role = "form" action="<?php echo site_url("home/save"); ?>"  method="POST">
           <div class = "form-group">
              <label for = "namadepan" class = "col-sm-2 control-label">Nama Depan</label>
              <div class = "col-sm-10">
                 <input type = "text" class = "form-control" name="nd" placeholder = "Nama Depan">
              </div>
           </div>
           <div class = "form-group">
              <label for = "namabelakang" class = "col-sm-2 control-label">Nama Belakang</label>
              <div class = "col-sm-10">
                 <input type = "text" class = "form-control" name="nb" placeholder = "Nama Belakang">
              </div>
           </div>
           <div class = "form-group">
           ...
           <div class = "form-group">
              ...
              <div class = "col-sm-10">
                <div class='input-group date' id='datetimepicker'>
                  <input type='text' class="form-control" name="tgl" placeholder="Tanggal Lahir"/>
           ...
           <div class = "form-group">
              ...
              <div class = "col-sm-10">
                 <input type = "text" class = "form-control" name="pk" placeholder = "Pekerjaan">
              </div>
           </div>
           <div class = "form-group">
              <label for = "alamat" class = "col-sm-2 control-label">Alamat</label>
              <div class = "col-sm-10">
                 <textarea name="al" style="width:100%" placeholder="Alamat...." ></textarea>
              </div>
           </div>
           <div class = "form-group">
              <div class = "col-sm-offset-2 col-sm-10">
                 <button type = "submit" class = "btn btn-info"><i class="glyphicon glyphicon-floppy-saved"></i> Save</button>
